...
bacward_penalty = 4; 
long_bacward_penalty = 3;
curve_bacward_penalty = 3;
...
while degree <= 16
    if (degree == 2 || degree == 4 || degree == 6 || degree == 8 || degree == 10 || degree == 12 || degree == 14 || degree == 16)
        ...
        [primID, send_primitives] = primitive_function(straight_start_pose, straight_end_pose, p_straight, straight_start_pose, straight_end_pose_long, p_straight_long, primID, resolution, forward_penalty, long_forward_penalty, angles, print_stuff);
...
while degree <= 16
    if (degree == 2 || degree == 4 || degree == 6 || degree == 8 || degree == 10 || degree == 12 || degree == 14 || degree == 16)
        ...
        [primID, send_primitives] = primitive_function(straight_start_pose, straight_end_pose, p_straight, straight_start_pose, straight_end_pose_long, p_straight_long, primID, resolution, bacward_penalty, long_bacward_penalty, angles, print_stuff);
        primitives(primID-2) = send_primitives(primID-2);
        primitives(primID-1) = send_primitives(primID-1);
